...
static const uint256 hashGenesisBlock("0x00000acb1fa90ebb7ebb3a825f3da087266fbed5cae8d6ef4d2d22a4ec6c4a08");
...
public:
    ...
    {
        // ScryptChain: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // ScryptChain: get transaction coin age
...
public:
    ...
    // ScryptChain: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // ScryptChain: two types of block: proof-of-work or proof-of-stake
    ...
    // ScryptChain: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // ScryptChain: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // ScryptChain: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // ScryptChain: block index flags
    enum  
    {
